...
def tumb_protocol():
    ...
    q = 19 #taking any random no
    #Generating your public/private keypairs
    public, private = generate_keypair(p, q)
    print "P.H public key is ", public ," and private key is ", private
