...
def tumb_protocol():
    aaa=random.randint(1,101)
    print "predicted merchant ID = "+str(aaa)+" (say this no belongs to BOB)"
    print "***************************************************************"
    ...
    for x in xrange(1,5):
        temp = random.randrange(1000, 5000)
        print "Fake factors = ", temp
    print "Bob sending sigma = ",sigmaBob," to get 1 coin"
    print "Merchant ID"+str(aaa)+ " recived 1 coin successfully"
